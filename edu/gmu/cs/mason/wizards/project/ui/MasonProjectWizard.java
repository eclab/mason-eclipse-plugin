...
import edu.gmu.cs.mason.wizards.project.ui.wizardpage.PropertiesPage;
...
public class MasonProjectWizard extends Wizard implements INewWizard
{
	...
	// The function of generating may further transfer to the be the function of
	// model
	...
	public void addPages()
	{
		...
		infoPage = new ProjectInfoPage("InfoPage", projectInfo);
		addPage(infoPage);
		infoPage.setWizard(this);

		// This page gather the information of SimState class
		// The information could be the name of the class, the information of
		// field
		...
		// The information includes how the agents is scheduled, and which field
		// it scheduled.
		// this.agentsPage = new AgentsPage("AgentsPage",projectInfo);
		// addPage(this.agentsPage);
		// agentsPage.setWizard(this);

		// This page gather the information of properties
		this.propertiesPage = new PropertiesPage("PropertiesPage", projectInfo);
		addPage(propertiesPage);
		propertiesPage.setWizard(this);
	...
	// After we collect the information of the project, we start to generate
	// code here
	@Override
